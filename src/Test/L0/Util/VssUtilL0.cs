        ...
        public void VerifyOverwriteVssConnectionSetting()
        {
            using (TestHostContext hc = new(this))
            {
                ...
                try
                {
                    ...
                    var connect = VssUtil.CreateConnection(new Uri("https://github.com/Water-Melon/runner"), new VssCredentials());
                    ...
                    connect = VssUtil.CreateConnection(new Uri("https://github.com/Water-Melon/runner"), new VssCredentials());
