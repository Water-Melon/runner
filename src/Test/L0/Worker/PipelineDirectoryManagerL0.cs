    ...
    public sealed class PipelineDirectoryManagerL0
    {
        ...
        public void UpdatesRepositoryDirectoryWorkspaceRepo()
        {
            ...
            using (TestHostContext hc = Setup())
            {
                ...
                // Act.
                _pipelineDirectoryManager.UpdateRepositoryDirectory(_ec.Object, "Water-Melon/runner", Path.Combine(hc.GetDirectory(WellKnownDirectory.Work), _existingConfig.PipelineDirectory, "my_new_path"), true);
